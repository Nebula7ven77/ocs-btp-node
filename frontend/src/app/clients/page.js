...
export default function ClientsPage() {
  ...
  return (
    <AppLayout titre="Clients" sousTitre="Base clients CRM">
      <div className="space-y-5">
        {/* En-tête */}
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg font-black">{/* Clients */}</h1>
            <p className="text-xs text-[var(--text-3)] mt-1">Base clients CRM</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="card">
            ...
            <div className="p-8 text-center text-xs text-[var(--text-3)]">
              ...
              <div className="font-semibold mb-2">Module Clients opérationnel</div>
