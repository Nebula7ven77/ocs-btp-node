...
export default function AnalyticsPage() {
  ...
  return (
    <AppLayout titre="Analytique" sousTitre="KPIs et tableaux">
      <div className="space-y-5">
        {/* En-tête */}
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg font-black">{/* Analytique */}</h1>
            <p className="text-xs text-[var(--text-3)] mt-1">KPIs et tableaux</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="card">
            <div className="card-header">
              <div className="card-title">Analytique</div>
            </div>
            <div className="p-8 text-center text-xs text-[var(--text-3)]">
              <div className="text-4xl mb-4">📋</div>
              <div className="font-semibold mb-2">Module Analytique opérationnel</div>
