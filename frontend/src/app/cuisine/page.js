...
export default function CuisinePage() {
  ...
  return (
    <AppLayout titre="Cuisine KDS" sousTitre="Affichage cuisine live">
      <div className="space-y-5">
        {/* En-tête */}
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg font-black">{/* Cuisine KDS */}</h1>
            <p className="text-xs text-[var(--text-3)] mt-1">Affichage cuisine live</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="card">
            <div className="card-header">
              <div className="card-title">Cuisine KDS</div>
            </div>
            <div className="p-8 text-center text-xs text-[var(--text-3)]">
              <div className="text-4xl mb-4">📋</div>
              <div className="font-semibold mb-2">Module Cuisine KDS opérationnel</div>
