...
export default function MaintenancePage() {
  ...
  return (
    <AppLayout titre="Maintenance" sousTitre="Tickets techniques">
      <div className="space-y-5">
        {/* En-tête */}
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg font-black">{/* Maintenance */}</h1>
            <p className="text-xs text-[var(--text-3)] mt-1">Tickets techniques</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="card">
            ...
            <div className="p-8 text-center text-xs text-[var(--text-3)]">
              ...
              <div className="font-semibold mb-2">Module Maintenance opérationnel</div>
